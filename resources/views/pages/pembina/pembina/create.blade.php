...
<body>
  ...
  <nav class="navbar navbar-expand-xl" id="layout-navbar">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <span class="fw-bold fs-5">Tambah Pembina</span>
      ...
      <form action="{{ route('pembina.pembina.store') }}" method="POST">
        ...
        <div class="row mb-3">
          <div class="col-md-6 mb-3">
            ...
            @error('nama_lengkap')<div class="alert alert-danger">{{ $message }}</div>@enderror
          </div>

          <div class="col-md-6 mb-3">
            <label for="nis_k">NIP</label>
            <input type="text" class="form-control" id="nis_k" name="nis_k" required>
            @error('nis_k')<div class="alert alert-danger">{{ $message }}</div>@enderror
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6 mb-3">
            ...
            @error('no_telp')<div class="alert alert-danger">{{ $message }}</div>@enderror
          </div>
        </div>
