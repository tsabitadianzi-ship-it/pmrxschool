...
<div class="main-area">
    <div class="card-detail">
        ...
        <div class="text-center mt-5">
            <a href="{{ route('siswa.materi') }}" class="btn btn-sm btn-back">
...
.download-link { color:#219EBC; font-weight:500; transition:.2s; }
.download-link:hover { color:#176b86; text-decoration:underline; }
.btn-back {
...
.btn-back:hover { background-color:#197b9b; transform:translateY(-2px); }
</style>
@endpush
