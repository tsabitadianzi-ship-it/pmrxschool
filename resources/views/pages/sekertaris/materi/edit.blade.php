...
<body>
  ...
  <nav class="navbar navbar-expand-xl" id="layout-navbar">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <span class="fw-bold fs-5">Edit Materi</span>
      ...
      <form action="{{ route('sekertaris.materi.update', $materi->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $materi->tanggal) }}" required>
            @error('tanggal')
        ...
        <div class="mb-3">
          ...
          @if($materi->file)
            <p class="text-muted">
              File saat ini:
              <a href="{{ asset('uploads/materi/' . $materi->file) }}" target="_blank">{{ $materi->file }}</a>
            </p>
          @endif
